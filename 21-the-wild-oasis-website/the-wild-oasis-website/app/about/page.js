		...
		<div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
			<div className="col-span-3">
				...
				<div className="space-y-8">
					...
					<p>
						Our {totalCabins.length} luxury cabins provide a cozy base, but the real freedom and peace you&apos;ll find
						in the surrounding mountains. Wander through lush forests, breathe in the fresh air, and watch the stars
			...
			{/* Fake dynamic image loading*/}
			<div className="col-span-2 relative aspect-square">
				<Image src={image1} fill className="object-cover" alt="Family sitting around a fire pit in front of cabin" />
			</div>

			<div className="col-span-2">
				<Image src={image2} placeholder="blur" className="object-cover" alt="Family that manages The Wild Oasis" />
			</div>
